...
def main():
    ...
    parser.add_argument('--target_image_path', type=str, help='Path to the target image file.')
    parser.add_argument('--target_model_path', type=str, help='Path or Hub ID for the target image generation model.')

    # --- Mutator Model Parameters ---
    # For VLM, only OpenAI models are supported in this script. Adapt utils_image.py for local models.
    parser.add_argument('--image_model_path', type=str, help='VLM model used to generate the initial prompt.')
    parser.add_argument('--model_path', type=str, help='LLM model used for prompt mutation.')
    ...
    parser.add_argument('--base_only', type=bool, default=False, help='If True, restrict mutations to base prompt only (enrichments and grammar fixes).')
    ...
    # --- Logging Parameters ---
    parser.add_argument('--openai_key', type=str, help='OpenAI key for Mutator LLM if using OpenAI models.')
